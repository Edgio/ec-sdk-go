...
func (m *HyperionCollectionCodeName) validateItems(formats strfmt.Registry) error {
...
func (m *HyperionCollectionCodeName) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HyperionCollectionCodeName) UnmarshalBinary(b []byte) error {
	var res HyperionCollectionCodeName
