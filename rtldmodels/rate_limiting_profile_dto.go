...
func (m *RateLimitingProfileDto) validateFilters(formats strfmt.Registry) error {
...
func (m *RateLimitingProfileDto) contextValidateFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RateLimitingProfileDto) UnmarshalBinary(b []byte) error {
	var res RateLimitingProfileDto
