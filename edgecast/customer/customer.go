...
func (svc *CustomerService) AddCustomer(
	...
	if err != nil {
		return "", fmt.Errorf("CustomerService.AddCustomer: %v", err)
	}
...
func (svc *CustomerService) GetCustomer(
	...
	if err != nil {
		return nil, fmt.Errorf("CustomerService.GetCustomer: %v", err)
	}
...
func (svc *CustomerService) UpdateCustomer(params UpdateCustomerParams) error {
	...
	if err != nil {
		return fmt.Errorf("CustomerService.UpdateCustomer: %v", err)
	}
	return nil
}
...
func (svc *CustomerService) DeleteCustomer(params DeleteCustomerParams) error {
	...
	if err != nil {
		return fmt.Errorf("CustomerService.DeleteCustomer: %v", err)
	}
	return nil
}
...
func (svc *CustomerService) GetAvailableCustomerServices() (*[]Service, error) {
	...
	if err != nil {
		return nil,
			fmt.Errorf("CustomerService.GetAvailableCustomerServices: %v", err)
	}
	return parsedResponse, nil
}
...
func (svc *CustomerService) GetCustomerServices(
	...
	if err != nil {
		return nil,
			fmt.Errorf("CustomerService.GetCustomerServices: %v", err)
	}
	return parsedResponse, nil
}
...
func (svc *CustomerService) GetCustomerDeliveryRegion(
	...
	if err != nil {
		return nil,
			fmt.Errorf("CustomerService.GetCustomerDeliveryRegion: %v", err)
	}
	return parsedResponse, nil
}
...
func (svc *CustomerService) UpdateCustomerDeliveryRegion(
	...
	if err != nil {
		return fmt.Errorf(
			"CustomerService.UpdateCustomerDeliveryRegion: %v",
			err)
	}
	return nil
}
...
func (svc *CustomerService) GetCustomerDomainTypes() (*[]DomainType, error) {
	...
	if err != nil {
		return nil,
			fmt.Errorf("CustomerService.GetCustomerDomainTypes: %v", err)
	}
	return parsedResponse, nil
}
...
func (svc *CustomerService) UpdateCustomerDomainURL(
	...
	if err != nil {
		return fmt.Errorf(
			"CustomerService.UpdateCustomerDomainURL: %v",
			err)
	}
	return nil
}
...
func (svc *CustomerService) GetCustomerAccessModules(
	...
	if err != nil {
		return nil,
			fmt.Errorf("CustomerService.GetCustomerAccessModules: %v", err)
	}
	return parsedResponse, nil
}
...
func (svc *CustomerService) UpdateCustomerAccessModule(
	...
	for _, accessModuleID := range params.AccessModuleIDs {
		...
		if err != nil {
			return fmt.Errorf(
				"CustomerService.UpdateCustomerAccessModule: %v",
				err)
		}
	}
	return nil
