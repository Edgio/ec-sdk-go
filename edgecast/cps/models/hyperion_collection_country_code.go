...
func (m *HyperionCollectionCountryCode) validateItems(formats strfmt.Registry) error {
...
func (m *HyperionCollectionCountryCode) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HyperionCollectionCountryCode) UnmarshalBinary(b []byte) error {
	var res HyperionCollectionCountryCode
