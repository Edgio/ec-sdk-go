...
func (m *HyperionCollectionNamedEntity) validateItems(formats strfmt.Registry) error {
...
func (m *HyperionCollectionNamedEntity) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HyperionCollectionNamedEntity) UnmarshalBinary(b []byte) error {
	var res HyperionCollectionNamedEntity
