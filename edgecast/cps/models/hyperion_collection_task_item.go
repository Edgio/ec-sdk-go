...
func (m *HyperionCollectionTaskItem) validateItems(formats strfmt.Registry) error {
...
func (m *HyperionCollectionTaskItem) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HyperionCollectionTaskItem) UnmarshalBinary(b []byte) error {
	var res HyperionCollectionTaskItem
