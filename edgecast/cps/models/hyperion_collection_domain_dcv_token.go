...
func (m *HyperionCollectionDomainDcvToken) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HyperionCollectionDomainDcvToken) validateItems(formats strfmt.Registry) error {
...
func (m *HyperionCollectionDomainDcvToken) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HyperionCollectionDomainDcvToken) UnmarshalBinary(b []byte) error {
	var res HyperionCollectionDomainDcvToken
