...
// NewTaskDeleteParams creates a new TaskDeleteParams object,
...
// TaskDeleteParams contains all the parameters to send to the API
// endpoint for the task delete operation. Typically these are written
// to a http.Request.
