...
// NewAppendixGetRequestTypeParams creates a new AppendixGetRequestTypeParams object,
...
func NewAppendixGetRequestTypeParams() AppendixGetRequestTypeParams {
	return AppendixGetRequestTypeParams{}
}

// AppendixGetRequestTypeParams contains all the parameters to send to the API
// endpoint for the appendix get request type operation. Typically these are written
// to a http.Request.
...
func (o *AppendixGetRequestTypeParams) WithDefaults() *AppendixGetRequestTypeParams {
	o.SetDefaults()
	return o
}
