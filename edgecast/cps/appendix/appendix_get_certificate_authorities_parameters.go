...
// NewAppendixGetCertificateAuthoritiesParams creates a new AppendixGetCertificateAuthoritiesParams object,
...
func NewAppendixGetCertificateAuthoritiesParams() AppendixGetCertificateAuthoritiesParams {
	return AppendixGetCertificateAuthoritiesParams{}
}

// AppendixGetCertificateAuthoritiesParams contains all the parameters to send to the API
// endpoint for the appendix get certificate authorities operation. Typically these are written
// to a http.Request.
...
func (o *AppendixGetCertificateAuthoritiesParams) WithDefaults() *AppendixGetCertificateAuthoritiesParams {
	o.SetDefaults()
	return o
}
