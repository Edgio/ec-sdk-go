...
// NewAppendixGetCancelActionsParams creates a new AppendixGetCancelActionsParams object,
...
func NewAppendixGetCancelActionsParams() AppendixGetCancelActionsParams {
	return AppendixGetCancelActionsParams{}
}

// AppendixGetCancelActionsParams contains all the parameters to send to the API
// endpoint for the appendix get cancel actions operation. Typically these are written
// to a http.Request.
...
func (o *AppendixGetCancelActionsParams) WithDefaults() *AppendixGetCancelActionsParams {
	o.SetDefaults()
	return o
}
