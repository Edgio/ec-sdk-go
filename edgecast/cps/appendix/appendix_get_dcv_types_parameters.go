...
// NewAppendixGetDcvTypesParams creates a new AppendixGetDcvTypesParams object,
...
func NewAppendixGetDcvTypesParams() AppendixGetDcvTypesParams {
	return AppendixGetDcvTypesParams{}
}

// AppendixGetDcvTypesParams contains all the parameters to send to the API
// endpoint for the appendix get dcv types operation. Typically these are written
// to a http.Request.
...
func (o *AppendixGetDcvTypesParams) WithDefaults() *AppendixGetDcvTypesParams {
	o.SetDefaults()
	return o
}
