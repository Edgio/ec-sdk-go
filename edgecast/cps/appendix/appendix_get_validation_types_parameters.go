...
// NewAppendixGetValidationTypesParams creates a new AppendixGetValidationTypesParams object,
...
func NewAppendixGetValidationTypesParams() AppendixGetValidationTypesParams {
	return AppendixGetValidationTypesParams{}
}

// AppendixGetValidationTypesParams contains all the parameters to send to the API
// endpoint for the appendix get validation types operation. Typically these are written
// to a http.Request.
...
func (o *AppendixGetValidationTypesParams) WithDefaults() *AppendixGetValidationTypesParams {
	o.SetDefaults()
	return o
}
