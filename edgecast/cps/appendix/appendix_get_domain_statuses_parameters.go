...
// NewAppendixGetDomainStatusesParams creates a new AppendixGetDomainStatusesParams object,
...
func NewAppendixGetDomainStatusesParams() AppendixGetDomainStatusesParams {
	return AppendixGetDomainStatusesParams{}
}

// AppendixGetDomainStatusesParams contains all the parameters to send to the API
// endpoint for the appendix get domain statuses operation. Typically these are written
// to a http.Request.
...
func (o *AppendixGetDomainStatusesParams) WithDefaults() *AppendixGetDomainStatusesParams {
	o.SetDefaults()
	return o
}
