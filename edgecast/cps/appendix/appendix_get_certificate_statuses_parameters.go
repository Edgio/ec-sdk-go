...
// NewAppendixGetCertificateStatusesParams creates a new AppendixGetCertificateStatusesParams object,
...
func NewAppendixGetCertificateStatusesParams() AppendixGetCertificateStatusesParams {
	return AppendixGetCertificateStatusesParams{}
}

// AppendixGetCertificateStatusesParams contains all the parameters to send to the API
// endpoint for the appendix get certificate statuses operation. Typically these are written
// to a http.Request.
...
func (o *AppendixGetCertificateStatusesParams) WithDefaults() *AppendixGetCertificateStatusesParams {
	o.SetDefaults()
	return o
}
