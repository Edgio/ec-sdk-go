...
// NewAppendixGetOrderStatusesParams creates a new AppendixGetOrderStatusesParams object,
...
func NewAppendixGetOrderStatusesParams() AppendixGetOrderStatusesParams {
	return AppendixGetOrderStatusesParams{}
}

// AppendixGetOrderStatusesParams contains all the parameters to send to the API
// endpoint for the appendix get order statuses operation. Typically these are written
// to a http.Request.
...
func (o *AppendixGetOrderStatusesParams) WithDefaults() *AppendixGetOrderStatusesParams {
	o.SetDefaults()
	return o
}
