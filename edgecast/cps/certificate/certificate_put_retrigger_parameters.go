...
// NewCertificatePutRetriggerParams creates a new CertificatePutRetriggerParams object,
...
func NewCertificatePutRetriggerParams() CertificatePutRetriggerParams {
	return CertificatePutRetriggerParams{}
}

// CertificatePutRetriggerParams contains all the parameters to send to the API
// endpoint for the certificate put retrigger operation. Typically these are written
// to a http.Request.
...
func (o *CertificatePutRetriggerParams) WithDefaults() *CertificatePutRetriggerParams {
	o.SetDefaults()
	return o
}
