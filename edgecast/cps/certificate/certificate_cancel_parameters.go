...
// NewCertificateCancelParams creates a new CertificateCancelParams object,
...
func NewCertificateCancelParams() CertificateCancelParams {
	return CertificateCancelParams{}
}

// CertificateCancelParams contains all the parameters to send to the API
// endpoint for the certificate cancel operation. Typically these are written
// to a http.Request.
...
func (o *CertificateCancelParams) WithDefaults() *CertificateCancelParams {
	o.SetDefaults()
	return o
}
...
func WriteToRequestCertificateCancelParams(o CertificateCancelParams) (RequestParameters, error) {
	...
	// query param apply
	qrApply := o.Apply
	qApply := swag.FormatBool(qrApply)
	if qApply != "" {

		params.QueryParams["apply"] = qApply
	}
