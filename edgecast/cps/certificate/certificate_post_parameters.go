...
// NewCertificatePostParams creates a new CertificatePostParams object,
...
func NewCertificatePostParams() CertificatePostParams {
	return CertificatePostParams{}
}

// CertificatePostParams contains all the parameters to send to the API
// endpoint for the certificate post operation. Typically these are written
// to a http.Request.
