...
// NewCertificateGetRequestNotificationsParams creates a new CertificateGetRequestNotificationsParams object,
...
func NewCertificateGetRequestNotificationsParams() CertificateGetRequestNotificationsParams {
	return CertificateGetRequestNotificationsParams{}
}

// CertificateGetRequestNotificationsParams contains all the parameters to send to the API
// endpoint for the certificate get request notifications operation. Typically these are written
// to a http.Request.
...
func (o *CertificateGetRequestNotificationsParams) WithDefaults() *CertificateGetRequestNotificationsParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CertificateGetRequestNotificationsParams) SetDefaults() {
