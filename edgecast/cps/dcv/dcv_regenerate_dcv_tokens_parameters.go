...
// NewDcvRegenerateDcvTokensParams creates a new DcvRegenerateDcvTokensParams object,
...
func NewDcvRegenerateDcvTokensParams() DcvRegenerateDcvTokensParams {
	return DcvRegenerateDcvTokensParams{}
}

// DcvRegenerateDcvTokensParams contains all the parameters to send to the API
// endpoint for the dcv regenerate dcv tokens operation. Typically these are written
// to a http.Request.
...
func (o *DcvRegenerateDcvTokensParams) WithDefaults() *DcvRegenerateDcvTokensParams {
	o.SetDefaults()
	return o
}
