...
// NewDcvPostEmailResendParams creates a new DcvPostEmailResendParams object,
...
func NewDcvPostEmailResendParams() DcvPostEmailResendParams {
	return DcvPostEmailResendParams{}
}

// DcvPostEmailResendParams contains all the parameters to send to the API
// endpoint for the dcv post email resend operation. Typically these are written
// to a http.Request.
...
func (o *DcvPostEmailResendParams) WithDefaults() *DcvPostEmailResendParams {
	o.SetDefaults()
	return o
}
