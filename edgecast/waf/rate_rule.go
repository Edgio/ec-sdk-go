...
// ) (*AddRateRuleResponse, error) {
// 	url := fmt.Sprintf(
// 		"/v2/mcc/customers/%s/waf/v1.0/limit",
// 		params.AccountNumber)
// 	req, err := svc.Client.BuildRequest("POST", url, params.RateRule)
// 	if err != nil {
...
// ) (*GetRateRuleResponse, error) {
// 	url := fmt.Sprintf(
// 		"/v2/mcc/customers/%s/waf/v1.0/limit/%s",
// 		params.AccountNumber,
// 		params.RateRuleID)
...
// 	_, err = svc.Client.SendRequest(req, &resp)
// 	if err != nil {
// 		return nil, fmt.Errorf("GetRateRule: %v", err)
// 	}
...
// ) (*UpdateRateRuleResponse, error) {
// 	url := fmt.Sprintf(
// 		"/v2/mcc/customers/%s/waf/v1.0/limit/%s",
// 		params.AccountNumber,
// 		params.RateRuleID)
// 	req, err := svc.Client.BuildRequest("PUT", url, params.RateRule)
// 	if err != nil {
// 		return nil, fmt.Errorf("UpdateRateRule: %v", err)
// 	}

// 	parsedResponse := &UpdateRateRuleResponse{}
// 	_, err = svc.Client.SendRequest(req, &parsedResponse)
// 	if err != nil {
// 		return nil, fmt.Errorf("UpdateRateRule: %v", err)
// 	}
...
// 	if err != nil {
// 		return nil, fmt.Errorf("DeleteRateRule: %v", err)
// 	}

// 	var parsedResponse = &DeleteRateRuleResponse{}
// 	_, err = svc.Client.SendRequest(req, &parsedResponse)
// 	if err != nil {
// 		return nil, fmt.Errorf("DeleteRateRule: %v", err)
// 	}
...
// 	var parsedResponse = &[]RateRuleLight{}
// 	_, err = svc.Client.SendRequest(req, &parsedResponse)
// 	if err != nil {
// 		return nil, fmt.Errorf("GetAllRateRules: %v", err)
// 	}
...
// // UpdateRateRuleResponse -
// type UpdateRateRuleResponse struct {
// 	UpdateRuleResponse
// }
...
// // DeleteRateRuleResponse -
// type DeleteRateRuleResponse struct {
// 	DeleteRuleResponse
// }
