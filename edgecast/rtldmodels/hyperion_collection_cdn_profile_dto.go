...
func (m *HyperionCollectionCdnProfileDto) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HyperionCollectionCdnProfileDto) validateItems(formats strfmt.Registry) error {
...
func (m *HyperionCollectionCdnProfileDto) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HyperionCollectionCdnProfileDto) UnmarshalBinary(b []byte) error {
	var res HyperionCollectionCdnProfileDto
