...
func (m *HyperionCollectionRtldPlatformSettingDto) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HyperionCollectionRtldPlatformSettingDto) validateItems(formats strfmt.Registry) error {
...
func (m *HyperionCollectionRtldPlatformSettingDto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HyperionCollectionRtldPlatformSettingDto) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HyperionCollectionRtldPlatformSettingDto) UnmarshalBinary(b []byte) error {
	var res HyperionCollectionRtldPlatformSettingDto
