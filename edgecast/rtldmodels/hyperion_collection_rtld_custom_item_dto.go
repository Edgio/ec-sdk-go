...
func (m *HyperionCollectionRtldCustomItemDto) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HyperionCollectionRtldCustomItemDto) validateItems(formats strfmt.Registry) error {
...
func (m *HyperionCollectionRtldCustomItemDto) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HyperionCollectionRtldCustomItemDto) UnmarshalBinary(b []byte) error {
	var res HyperionCollectionRtldCustomItemDto
