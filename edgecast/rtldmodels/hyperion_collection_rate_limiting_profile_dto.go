...
func (m *HyperionCollectionRateLimitingProfileDto) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HyperionCollectionRateLimitingProfileDto) validateItems(formats strfmt.Registry) error {
...
func (m *HyperionCollectionRateLimitingProfileDto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HyperionCollectionRateLimitingProfileDto) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HyperionCollectionRateLimitingProfileDto) UnmarshalBinary(b []byte) error {
	var res HyperionCollectionRateLimitingProfileDto
