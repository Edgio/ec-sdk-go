...
func (m *HyperionCollectionWafProfileDto) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HyperionCollectionWafProfileDto) validateItems(formats strfmt.Registry) error {
...
func (m *HyperionCollectionWafProfileDto) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HyperionCollectionWafProfileDto) UnmarshalBinary(b []byte) error {
	var res HyperionCollectionWafProfileDto
